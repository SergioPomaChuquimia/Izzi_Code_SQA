...
class TestCrearMarca:
    def setup_method(self):
        ...
        #self.driver.find_element(By.XPATH,"//ion-menu-button").click()
        #time.sleep(1)
        #self.driver.find_element(By.XPATH,"//ion-item[text()='Marcas']").click()
        #time.sleep(2)
        #self.driver.find_element(By.XPATH,"//ion-button[@class='sc-ion-buttons-md md button button-clear in-toolbar in-buttons button-has-icon-only ion-activatable ion-focusable hydrated']").click()
        #time.sleep(1)
    ...
    def test_crearMarca(self):
        ...
        #self.driver.find_element(By.XPATH,"(//input[@class='native-input sc-ion-input-md'])[4]").send_keys("asdf@gmail.com")
        #time.sleep(1)
    ...
    def test_editarMarca(self):
        ...
        self.driver.find_element(By.XPATH,"//button[@class='alert-button ion-focusable ion-activatable sc-ion-alert-md']").click()
        time.sleep(1)
        #self.driver.find_element(By.XPATH,"(//input[@class='native-input sc-ion-input-md'])[5]").clear()
        self.driver.find_element(By.XPATH,"//input[@name='email']").clear()
        #self.driver.find_element(By.XPATH,"(//input[@class='native-input sc-ion-input-md'])[5]").send_keys("editadoasdf@gmail.com")
